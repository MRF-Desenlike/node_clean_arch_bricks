...
import { InMemorySearchableRepositoryAsterisk } from '@/shared/domain/repositories/in-memory-searchable-asterisk.repository'
import { SortDirection } from '@/shared/domain/repositories/searchable-repository-contracts'
import { StringUtils } from '@/shared/utils/string.utils'

export class {{module_name.pascalCase()}}InMemoryRepository
  extends InMemorySearchableRepositoryAsterisk<{{module_name.pascalCase()}}Entity>
